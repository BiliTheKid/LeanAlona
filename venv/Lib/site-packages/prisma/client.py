...
SCHEMA_PATH = Path('C:/Users/yarde/Desktop/DevPipe/LeanAlona/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\yarde\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    settlement: 'actions.SettlementActions[models.Settlement]'
    ...
    def __init__(
        ...
        *,
        ...
        self.settlement = actions.SettlementActions[models.Settlement](self, models.Settlement)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://tourismuser:ov6q4tBAxv04hZ4Wi4UT6KeZRtFHirYF@dpg-cqu7b9jv2p9s73d271s0-a.frankfurt-postgres.render.com/tourismdb_1ppd', 'fromEnvVar': None}).resolve(),
            'source_file_path': 'C:/Users/yarde/Desktop/DevPipe/LeanAlona/prisma/schema.prisma',
        }
...
class Batch:
    ...
    settlement: 'SettlementBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.settlement = SettlementBatchActions(self)
